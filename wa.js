...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  body{font-family:Inter,'Segoe UI',system-ui,sans-serif;color:var(--text);min-height:100vh;letter-spacing:0;background:linear-gradient(115deg,rgba(255,255,255,.88),rgba(232,249,255,.68) 38%,rgba(255,244,232,.7) 100%),conic-gradient(from 220deg at 18% 18%,#ffe28a,#6ee7d8,#7da8ff,#ff92bd,#ffe28a);background-attachment:fixed}
  ...
  .shell{position:relative;z-index:1;min-height:100vh;display:grid;grid-template-columns:280px minmax(0,1fr);gap:18px;padding:18px}
  .sidebar{background:rgba(13,29,48,.62);border:1px solid rgba(255,255,255,.22);color:#f7fbff;padding:18px 14px;display:flex;flex-direction:column;gap:18px;position:sticky;top:18px;height:calc(100vh - 36px);border-radius:8px;box-shadow:0 26px 70px rgba(10,33,55,.28);backdrop-filter:blur(24px) saturate(145%);-webkit-backdrop-filter:blur(24px) saturate(145%)}
  .brand{display:flex;align-items:center;gap:12px;padding:6px 4px}
  .mark{width:44px;height:44px;border-radius:8px;background:linear-gradient(135deg,#18d49e,#2f74ff 58%,#ff78b7);color:white;display:grid;place-items:center;font-weight:900;box-shadow:0 16px 34px rgba(51,121,255,.32)}
  .brand h1{font-size:1rem;line-height:1.2}.brand small{display:block;color:#c2d4e5;font-size:.76rem;margin-top:3px}
  .nav{display:grid;gap:7px}
  .nav-item{width:100%;border:1px solid transparent;background:rgba(255,255,255,.05);color:#dbe8f4;border-radius:8px;padding:10px 11px;display:flex;align-items:center;gap:10px;cursor:pointer;text-align:left;font-weight:800;font-size:.86rem;transition:background .18s ease,border-color .18s ease,transform .18s ease}
  ...
  .topbar{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap;background:var(--paper);border:1px solid var(--line);border-radius:8px;padding:17px;box-shadow:var(--shadow);backdrop-filter:blur(24px) saturate(150%);-webkit-backdrop-filter:blur(24px) saturate(150%)}
  ...
  .btn{border:1px solid var(--line-strong);background:rgba(255,255,255,.7);border-radius:8px;padding:9px 12px;cursor:pointer;font-weight:850;transition:background .18s ease,border-color .18s ease,box-shadow .18s ease,transform .18s ease;box-shadow:0 8px 24px rgba(36,82,126,.08)}
  ...
  .metric-card,.panel-card,.mini,.radar-card{background:var(--paper);border:1px solid var(--line);border-radius:8px;box-shadow:var(--shadow);backdrop-filter:blur(22px) saturate(150%);-webkit-backdrop-filter:blur(22px) saturate(150%)}
  ...
  .finance-hero{position:relative;overflow:hidden;background:linear-gradient(135deg,rgba(17,47,80,.88),rgba(25,111,143,.8) 44%,rgba(235,91,149,.68));color:#f8fcff;border:1px solid rgba(255,255,255,.28);border-radius:8px;padding:22px;display:grid;grid-template-columns:minmax(0,1.28fr) repeat(3,minmax(135px,.5fr));gap:14px;align-items:center;box-shadow:0 26px 70px rgba(26,76,116,.26);backdrop-filter:blur(22px) saturate(150%);-webkit-backdrop-filter:blur(22px) saturate(150%)}
  .finance-hero:before{content:"";position:absolute;inset:0;background:linear-gradient(120deg,rgba(255,255,255,.2),rgba(255,255,255,0) 42%,rgba(255,255,255,.14));pointer-events:none}.hero-copy,.hero-stat{position:relative}.hero-copy h3{font-size:1.22rem}.hero-copy p{color:#d7e8f3;font-size:.86rem;margin-top:6px;max-width:620px}.hero-stat{background:rgba(255,255,255,.13);border:1px solid rgba(255,255,255,.22);border-radius:8px;padding:13px}.hero-stat span{display:block;color:#c7ddeb;font-size:.74rem}.hero-stat b{display:block;font-size:1.08rem;margin-top:5px}.score{color:#75f0bd}
  ...
  @media (max-width:1120px){.shell{grid-template-columns:1fr}.sidebar{position:static;height:auto}.nav{grid-template-columns:repeat(4,minmax(0,1fr))}.side-meta{margin-top:0}.metric-grid,.mini-grid,.budget-summary{grid-template-columns:repeat(2,1fr)}.panel-grid,.panel-grid.equal{grid-template-columns:1fr}.finance-hero{grid-template-columns:1fr repeat(3,minmax(120px,1fr))}.smart-radar{grid-template-columns:repeat(2,minmax(0,1fr))}}
  @media (max-width:720px){.shell{padding:12px}.content{gap:14px}.nav{grid-template-columns:repeat(2,minmax(0,1fr))}.metric-grid,.mini-grid,.budget-summary,.trend-kpis,.smart-radar{grid-template-columns:1fr}.metric-card .value{font-size:1.05rem;word-break:normal}.status-grid,.form-grid,.finance-hero{grid-template-columns:1fr}.hero-stat{padding:12px}.form-group.full{grid-column:auto}.toolbar,.catalog-toolbar{align-items:stretch}.field,.search-field,.btn{width:100%}.table-wrap{max-height:420px}.chart-wrap{height:300px}.report-banner{align-items:flex-start;flex-direction:column}.report-balance{text-align:left}.topbar{padding:14px}}
</style>
</head>
<body>
<div class="shell">
