...
- Command `saldo binance`, `binance`, atau `aset binance` menampilkan total estimasi USDT, estimasi rupiah bila rate diisi, jumlah aset aktif, dan daftar top aset.
- Dashboard web memiliki halaman Binance khusus dan kartu ringkasan Binance di Overview.
- Data Binance memakai cache singkat agar realtime namun tidak membebani API.
...
| `BINANCE_CACHE_SECONDS` | Opsional | Cache saldo Binance, default `20` detik |
| `BINANCE_USDT_IDR_RATE` | Opsional | Rate USDT ke Rupiah untuk estimasi IDR, contoh `16400` |
