...
- Dashboard profesional berbasis menu agar hanya fitur yang sedang dibuka yang tampil.
- Desain dashboard dirombak ke tema **liquid glass** yang lebih berwarna, translusen, dan responsif.
- Tersedia Overview, Analitik, Laporan, Tren, Budget, Transaksi, Katalog Kategori, Sistem, Command, dan panel Super Admin.
...
- Halaman Laporan berisi ringkasan arus kas, tabungan akumulasi, tabel 12 bulan, transaksi lengkap, dan export CSV.
...
Minimal agar bot jalan di Railway: `SPREADSHEET_ID`, `GOOGLE_SERVICE_ACCOUNT_JSON`, `WHATSAPP_PHONE_NUMBER`, `DASHBOARD_BASE_URL`, dan `DASHBOARD_SECRET`. Tambahkan `OPENAI_API_KEY` untuk AI utama, lalu `GEMINI_API_KEY` bila ingin fallback.
...
export Mei 2026              -> Download transaksi bulan tertentu sebagai CSV
export tahun 2026            -> Download transaksi setahun sebagai CSV
